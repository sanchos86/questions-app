...
export class ReplaceMysqlWithPostgresql1649600833307 implements MigrationInterface {
    name = 'ReplaceMysqlWithPostgresql1649600833307'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "likes" ("id" SERIAL NOT NULL, "type" character varying NOT NULL, "userId" integer, "commentId" integer, "questionId" integer, CONSTRAINT "PK_a9323de3f8bced7539a794b4a37" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_b9ef264256fa1872e7fb53d728" ON "likes" ("type") `);
        await queryRunner.query(`CREATE TABLE "comments" ("id" SERIAL NOT NULL, "text" text NOT NULL, "deletedAt" TIMESTAMP, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "questionId" integer, "userId" integer, "parentCommentId" integer, CONSTRAINT "REL_4875672591221a61ace66f2d4f" UNIQUE ("parentCommentId"), CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('admin', 'author')`);
        await queryRunner.query(`CREATE TYPE "public"."users_status_enum" AS ENUM('confirmed', 'confirmation_process')`);
        ...
        await queryRunner.query(`CREATE TABLE "questions" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "plainText" text NOT NULL, "formattedText" text NOT NULL, "content" json NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "userId" integer, "categoryId" integer, CONSTRAINT "PK_08a6d4b0f49ff300bf3a0ca60ac" PRIMARY KEY ("id")); COMMENT ON COLUMN "questions"."plainText" IS 'Question text without html tags'; COMMENT ON COLUMN "questions"."formattedText" IS 'Question text with html tags'; COMMENT ON COLUMN "questions"."content" IS 'https://quilljs.com/docs/delta/'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "likes" DROP CONSTRAINT "FK_3a9880a74397ce4c59fe609f768"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b9ef264256fa1872e7fb53d728"`);
